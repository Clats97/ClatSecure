...
ROUND_COUNT = 12
KEY_SIZE = 24  # 24 bytes for AES-192
...
def generate_and_print_keys(password: bytes):
    for _ in range(100):  # Generate 100 keys
        try:
            ...
            # Convert key to uppercase hexadecimal and ensure it is 48 characters long
            hex_key = generated_key.hex().upper()
            print(f"Generated 192-bit key (hexadecimal):{hex_key}")
